    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <motion.p 
                  className="text-xl text-white/90 leading-relaxed text-pretty mb-8"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  {[
                    { icon: Award, value: "15+", label: locale === "ar" ? "سنة خبرة" : "Years Experience" },
                    { icon: Target, value: "500+", label: locale === "ar" ? "قضية ناجحة" : "Successful Cases" },
                    { icon: Clock, value: "24/7", label: locale === "ar" ? "دعم متاح" : "Support Available" },
                    { icon: CheckCircle, value: "98%", label: locale === "ar" ? "معدل النجاح" : "Success Rate" }
                  ].map((stat, index) => (
                    <motion.div
                      key={index}
                      className="text-center p-6 bg-zinc-700/60 rounded-lg"
                      variants={scaleIn}
        ...
        <section className="py-20 bg-[#060a12] text-white relative overflow-hidden">
          ...
          <motion.div 
            className="mx-auto relative max-w-7xl px-4 sm:px-6 lg:px-8 text-center"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
